...
public class Global
{
    ...
    public const string AppName = "KiNG";
    ...
    public const string AutoRunName = "KiNGAutoRun";
    ...
    public const string AvaAssets = "avares://KiNG/Assets/";
    public const string LocalAppData = "KiNG_LOCAL_APPLICATION_DATA_V2";
